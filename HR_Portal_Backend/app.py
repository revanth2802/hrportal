...
from controllers.document_resource import DocumentResource
...
api.add_resource(AverageSalaryPerDepartmentResource, '/average_salary_per_departmeh nt')
api.add_resource(TitleResource, '/titles/search', endpoint='title_search')
api.add_resource(DocumentResource, '/documents', '/documents/<int:document_id>')
