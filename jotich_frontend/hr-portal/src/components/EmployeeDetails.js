...
//     useEffect(() => {
//         if (employee && employee.emp_no) {  // Ensure the employee object exists and has emp_no property
...
//                     }
//                 })
//                 .catch(error => console.error("Error fetching current department:", error));

//             // Fetch employee manager details
